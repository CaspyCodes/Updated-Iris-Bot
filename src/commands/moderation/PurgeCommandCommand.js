...
module.exports = class PurgeCommandCommand extends BaseCommand {
  constructor() {
  ...
  async run(client, message, args) {
    ...
    if (!args[0]) return message.channel.send("You must state a number of messages to purge. \`m!purge number\`");
